...
void MainWindow::stepsChanged(unsigned long int s){
    ...
    ui->label_FitnessDisplay->setText(QString("Fitness: ").append(QString::number(ui->environmentWidget->getEnvironment()->getLastFitness())));
    ui->label_SpeedDisplay->setText(QString("Speed: ").append(QString::number(ui->environmentWidget->getEnvironment()->getLastSpeed())));
}
